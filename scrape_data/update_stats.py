...
class UfcAthleteSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if name:
            self.logger.info(f"Scraped fighter: {name}")
            yield { 
                #'fighter_info'
                ...
                'leg_reach': stats.get('leg_reach', '0'),
                ...
                'losses': losses,
                'draws': draws,
                'wins_by_knockout': stats.get('wins_by_knockout', '0'),
                #'wins_by_submission': stats.get('wins_by_submission', '0'),
                'first_round_finishes': stats.get('first_round_finishes', '0'),
                'win_by_dec': stats.get('win_by_dec', '0'),
                'win_by_sub': stats.get('win_by_sub', '0'),
                ...
                'sig_strikes_landed_per_minute': stats.get('sig_strikes_landed_per_minute', '0'),
                'sig_strikes_absorbed_per_minute': stats.get('sig_strikes_absorbed_per_minute', '0'),
                'takedowns_avg': stats.get('takedowns_avg', '0'),
                'submission_avg': stats.get('submission_avg', '0'),
                'sig_strikes_defense': stats.get('sig_strikes_defense', '0'),
                'takedown_defense': stats.get('takedown_defense', '0'),
                'knockdown_avg': stats.get('knockdown_avg', '0'),
                'fight_time_avg': stats.get('fight_time_avg', '0'),
                'sig_strikes_standing': stats.get('sig_strikes_standing', '0'),
                'sig_strikes_clinch': stats.get('sig_strikes_clinch', '0'),
                'sig_strikes_ground': stats.get('sig_strikes_ground', '0'),
                'head_target': stats.get('head_target', '0'),
                'body_target': stats.get('body_target', '0'),
                'leg_target': stats.get('leg_target', '0'),     
        }
        else:
            self.logger.warning(f"Name not found for URL: {response.url}")
